...
class LocalRepository {
  ...
  static LocalRepository fromRaw(Pointer<git_repository> repo) {
    final r = LocalRepository._internal(repo);
    _finalizer.attach(r, repo);
    return r;
  }

  static TaskEither<GitError, LocalRepository> open(String path) => 
    TaskEither(() async {
      ...
      try {
        ...
        if (result != 0) {
          return Left(GitError(kind: GitErrorKind.openRepo, msg: path));
        }
